...
} from "@/features/client-activities/constants/activityStatuses";
import { CLIENT_ACTIVITY_MEETING_VENUE_LABELS } from "@/features/client-activities/constants/meetingVenues";
import type {
  ClientActivityCall,
  ClientActivityMeeting,
  ClientActivityTask,
} from "@/features/client-activities/types/types";
import { formatActivityDateTime } from "@/features/client-activities/utils/activityDisplayUtils";
...
export function ActivityList(props: ActivityListProps) {
  const { items, canEdit, showProjectName = false } = props;
